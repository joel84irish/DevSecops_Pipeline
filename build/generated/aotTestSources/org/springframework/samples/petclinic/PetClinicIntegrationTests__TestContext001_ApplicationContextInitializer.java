 ...
 */
public class PetClinicIntegrationTests__TestContext001_ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new PetClinicIntegrationTests__TestContext001_BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new PetClinicIntegrationTests__TestContext001_BeanFactoryRegistrations().registerAliases(beanFactory);
  }
