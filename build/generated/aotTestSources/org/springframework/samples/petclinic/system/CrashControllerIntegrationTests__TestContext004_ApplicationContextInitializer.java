 ...
 */
public class CrashControllerIntegrationTests__TestContext004_ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new CrashControllerIntegrationTests__TestContext004_BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new CrashControllerIntegrationTests__TestContext004_BeanFactoryRegistrations().registerAliases(beanFactory);
  }
