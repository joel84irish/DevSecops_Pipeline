...
import org.springframework.data.jpa.repository.support.JpaRepositoryFactoryBean__TestContext003_Autowiring1;
import org.springframework.data.repository.query.QueryLookupStrategy;

/**
 * Bean definitions for {@link OwnerRepository}.
 */
public class OwnerRepository__TestContext003_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getOwnerRepositoryBeanDefinition() {
    ...
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, OwnerRepository.class, Object.class, Object.class));
    ...
    instanceSupplier = instanceSupplier.andThen(JpaRepositoryFactoryBean__TestContext003_Autowiring1::apply);
