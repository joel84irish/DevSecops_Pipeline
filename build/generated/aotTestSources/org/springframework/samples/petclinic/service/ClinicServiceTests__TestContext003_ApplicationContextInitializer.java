 ...
 */
public class ClinicServiceTests__TestContext003_ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new ClinicServiceTests__TestContext003_BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new ClinicServiceTests__TestContext003_BeanFactoryRegistrations().registerAliases(beanFactory);
  }
