 ...
 */
public class PostgresIntegrationTests__TestContext002_ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    DefaultListableBeanFactory beanFactory = applicationContext.getDefaultListableBeanFactory();
    beanFactory.setAutowireCandidateResolver(new ContextAnnotationAutowireCandidateResolver());
    beanFactory.setDependencyComparator(AnnotationAwareOrderComparator.INSTANCE);
    applicationContext.getEnvironment().addActiveProfile("postgres");
    addImportAwareBeanPostProcessors(beanFactory);
    new PostgresIntegrationTests__TestContext002_BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new PostgresIntegrationTests__TestContext002_BeanFactoryRegistrations().registerAliases(beanFactory);
  }
