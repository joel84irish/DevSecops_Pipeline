 ...
 */
public class TaskExecutorMetricsAutoConfiguration__TestContext001_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getTaskExecutorMetricsAutoConfigurationBeanDefinition() {
    ...
    instanceSupplier = instanceSupplier.andThen(TaskExecutorMetricsAutoConfiguration__TestContext001_Autowiring::apply);
