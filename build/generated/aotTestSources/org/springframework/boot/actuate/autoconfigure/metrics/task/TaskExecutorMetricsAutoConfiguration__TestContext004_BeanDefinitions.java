 ...
 */
public class TaskExecutorMetricsAutoConfiguration__TestContext004_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getTaskExecutorMetricsAutoConfigurationBeanDefinition() {
    ...
    instanceSupplier = instanceSupplier.andThen(TaskExecutorMetricsAutoConfiguration__TestContext004_Autowiring::apply);
