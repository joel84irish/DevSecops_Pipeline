 ...
 */
public class TaskExecutorMetricsAutoConfiguration__TestContext002_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getTaskExecutorMetricsAutoConfigurationBeanDefinition() {
    ...
    instanceSupplier = instanceSupplier.andThen(TaskExecutorMetricsAutoConfiguration__TestContext002_Autowiring::apply);
