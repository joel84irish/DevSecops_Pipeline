 ...
 */
public class WebMvcAutoConfiguration__TestContext002_BeanDefinitions {
  /**
  ...
  public static class EnableWebMvcConfiguration {
    ...
    public static BeanDefinition getEnableWebMvcConfigurationBeanDefinition() {
      ...
      instanceSupplier = instanceSupplier.andThen(WebMvcAutoConfiguration_EnableWebMvcConfiguration__TestContext002_Autowiring::apply);
