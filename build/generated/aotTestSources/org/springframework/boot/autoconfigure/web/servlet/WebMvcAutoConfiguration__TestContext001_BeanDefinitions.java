 ...
 */
public class WebMvcAutoConfiguration__TestContext001_BeanDefinitions {
  /**
  ...
  public static class EnableWebMvcConfiguration {
    ...
    public static BeanDefinition getEnableWebMvcConfigurationBeanDefinition() {
      ...
      instanceSupplier = instanceSupplier.andThen(WebMvcAutoConfiguration_EnableWebMvcConfiguration__TestContext001_Autowiring::apply);
