 ...
 */
public class AutoConfigurationPackages__TestContext004_BeanDefinitions {
  /**
  ...
  public static class BasePackages {
    ...
    public static BeanDefinition getAutoConfigurationPackagesBeanDefinition() {
      ...
      beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, new String[] {"org.springframework.samples.petclinic.system"});
